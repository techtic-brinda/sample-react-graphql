...
class ImageInput extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.value && nextProps.value !== "" && !this.state.valueUpdated){
            this.setState({
                    ...
                    {[...value, ...images].map((image, index) => {
                        return (
                            <div key={index} className={classes.previewItem}>
                                ...
                                <Button variant="raised" color="primary" component="span" className={classes.removePreview} onClick={(e) => this.removeSelectedFile(image)}>Remove</Button>
                            </div>
                        )
                    })}
                </div>
