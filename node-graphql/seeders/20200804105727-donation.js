...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    */
    const angels = await queryInterface.sequelize.query("SELECT * FROM users where email= 'angeluser_test@gmail.com' AND exists (SELECT 1 FROM role_user where user_id = users.id and role_id=2)", { type: QueryTypes.SELECT });
    ...
    console.log(donations_categories, donations);
